 ...
 * <p></p>
 * This class is an abstract class used to provide commun methods for avoiding
 * redondance in the code. WHen an entity manager need a function present in
 * this class, it should extend it.
 *
